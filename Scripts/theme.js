...
namespace Theme
{
	...
	const var TITLE = {colour:0xFFFFFFFF, fontName:"Open Sans Bold", size:26}; //Patch title text
	...
	const var BUTTON = {bg:0xFF111111, fg:0xFFC8AE52, text:0xFFFFFFFF, fontName:"Open Sans Bold", fontSize:18};
	const var PUSH_BUTTON = {off:0xFF555555, on:0xFF777777, text:0xFFFFFFFF, textAlt:0xFFDDDDDD, fontName:"Open Sans", fontSize:16};
	const var PRESET_BROWSER = {bg:0xFF333333, itemColour1:0xFFC8AE52};
